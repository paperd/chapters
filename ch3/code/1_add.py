...
if __name__ == "__main__":
    ...
    plt.savefig('Figure 3-1. Vector a from the Origin (0, 0) to (3, -1).jpeg')
    set_up()
    ax = plt.axes()
    ax.arrow(0, 0, 3, -1, head_width=0.1, fc='b', ec='b')
    ...
    ax.text(4, -0.1, 'b')
    ax.set_facecolor('honeydew')
    plt.savefig('Figure 3-2. Vector b from (3, -1) to (5, 2).jpeg')
    set_up()
    ax = plt.axes()
    ax.arrow(0, 0, 3, -1, head_width=0.1, fc='b', ec='b')
    ax.arrow(3, -1, 2, 3, head_width=0.1, fc='crimson', ec='crimson')
    ...
    ax.set_facecolor('honeydew')
    plt.savefig('Figure 3-3. Vector c from (0, 0) to (5, 2).jpeg')
