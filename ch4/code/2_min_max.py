...
if __name__ == "__main__":
    ...
    plt.savefig('Figure 4-2. Function f(x).jpeg')
    plt.close('f(x)')
    ...
    plt.savefig('Figure 4-3. Local minimum for function f(x).jpeg')
    plt.close('local minimum')
    ...
    plt.savefig('Figure 4-4. Local maximum for function f(x).jpeg')
    plt.close('local maximum')
