...
if __name__ == "__main__":
    ...
    plt.axis([-3,3,0,100])
    plt.grid(True)
    plt.savefig('Figure 5-1. Uniform Distribution.jpeg')
    plt.close('Uniform Distribution')
    ...
    plt.axis([-3,3,0,140])
    plt.grid(True)
    plt.savefig('Figure 5-2. Normal Distribution.jpeg')
    plt.close('Normal Distribution')
